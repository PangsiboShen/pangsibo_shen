...
tidy_df %>%
  ...
  layout(title = "The Boxplot of Inspection Score Across Major Cuisine Types")
```
...
tidy_df %>%
  ...
  layout(title = "The Percentage of Inspection Grade Across Borough")
```
...
rest_inspec %>%
  ...
  layout(title = "The Line Plot of Monthly Inspection Conducted From 2015 - 2017")
```
...
rest_inspec %>%
  ...
  layout(title = "The Boxplot of Inspection Score Across Major Chain Restaurant Brand")
```
